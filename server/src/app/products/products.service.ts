  ...
  async findOne(item: string) {
      ...
      const products: IProducts[] = await page.evaluate(() => {
        ...
        for (const element of productElements) {
          const nameElement: HTMLSpanElement = element.querySelector('.a-size-base-plus.a-color-base.a-text-normal');
          const priceWholeElement: HTMLSpanElement = element.querySelector('.a-price-whole');
          const priceFractionElement: HTMLSpanElement = element.querySelector('.a-price-fraction');
          const imageElement: HTMLImageElement = element.querySelector('.s-image');
          const linkElement: HTMLAnchorElement = element.querySelector('.a-link-normal.a-text-normal');
